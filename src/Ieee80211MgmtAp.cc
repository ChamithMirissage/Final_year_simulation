...
void Ieee80211MgmtAP::initialize(int stage)
{
    ...
    path = "results/singleSide_data_density_xx.csv";
    //path_AC0 = "results/xx_nodes_AC0.csv";
    //path_AC1 = "results/xx_nodes_AC1.csv";
    pathBrief="results/singleSide_msgSent_density_xx.csv";
    ...
    if (msg == beaconTimer) {
        if (round == 1){
            ...
            for (int i=0; i<nrolls; ++i){
                ...
                if (number == 1){
                    list_ac1.push_back(firstTrans.dbl() + double(i) + period/2);
                ...
                list_ac1.push_back(firstTrans.dbl() + double(i) + gap/2.0);
                ...
                for (int j=1; j<number; ++j){
                    list_ac1.push_back(prev_elem + gap);
            ...
            list_ac1.push_back(500.0);
            list_ac2.push_back(500.0);
            list_ac3.push_back(500.0);
...
//        myfile.close();
    ...
    fileBrief<<ssid+","+std::to_string(numSent)+","+std::to_string(numSentLC)+","+std::to_string(numSentSB)+","+std::to_string(numSentEV)<<endl;
    fileBrief.close();
